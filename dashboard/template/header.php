...
$q = mysqli_query($conn, "SELECT * FROM tb_users WHERE username='$b'");

// hitung hasil dan cek ada atau tidaknya data
// $is_exist = mysqli_num_rows($q);
// mengambil semua data berdasarkan username
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $c['nama'] ?></span>
